...
from Locators import click_reports, click_reports_users_buy_sell
...
# # # reports_users_buy_sell_phone_search
    ...
    def test02_reports_users_buy_phone_search(self):
...
# # # reports_users_sell_phone_search
    ...
    def test03_reports_users_sell_phone_search(self):
        reports = Reports(driver=self.driver)
...
# # # reports_users_buy_sell_name_search
    ...
    def test04_reports_users_buy_sell_name_search(self):
        reports = Reports(driver=self.driver)
        self.driver.refresh()
...
# # # reports_users_sell_name_search
    ...
    def test05_reports_users_sell_name_search(self):
        reports = Reports(driver=self.driver)
        reports.enter_reports_users_buy_sell_btn_sale()
        sleep(1)
        reports.enter_reports_users_buy_sell_phone_search_result()
